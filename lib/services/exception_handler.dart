...
//   }
//
//   static String checkApiStatusCode(int statusCode) {
//     String message = 'no message yet';
//     if (statusCode >= 100 && statusCode < 200) {
//       message = 'Informational Response: The request was received and understood.';
...
//           break;
//         case 204:
//           message = 'No Content: The request was successful but there is no content.';
//           break;
//         default:
//           message = 'Success: The request was successful with status code $statusCode.';
//       }
//     } else if (statusCode >= 300 && statusCode < 400) {
//       switch (statusCode) {
//         case 301:
//           message = 'Moved Permanently: The resource has been permanently moved.';
//           break;
//         case 302:
//           message = 'Found: The resource is temporarily located elsewhere.';
//           break;
//         case 304:
//           message = 'Not Modified: The cached version of the resource is still valid.';
//           break;
//         default:
//           message = 'Redirection: The request requires further action with status code $statusCode.';
//       }
...
//           break;
//         default:
//           message = 'Client Error: An error occurred with status code $statusCode.';
//       }
...
//           break;
//         case 501:
//           message = 'Not Implemented: The server does not support the requested functionality.';
//           break;
//           case 502:
//           message = 'Bad Gateway.';
//           break;
...
//           break;
//         default:
//           message = 'Server Error: An error occurred with status code $statusCode.';
//       }
//     } else {
...
//
//     log(message);
//     Get.snackbar("API message", message);
//     return message;
//   }
// }
